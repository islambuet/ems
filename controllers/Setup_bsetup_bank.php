...
class Setup_bsetup_bank extends Root_Controller
{
    ...
    {
        $items=Query_helper::get_info($this->config->item('table_basic_setup_bank'),array('id','name','description','ordering'),array('status !="'.$this->config->item('system_status_delete').'"'));
