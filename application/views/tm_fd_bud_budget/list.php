        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    {
                        text: '<?php echo $CI->lang->line('LABEL_SL_NO'); ?>',datafield: '',pinned:true,width:'70', columntype: 'number',cellsalign: 'right',sortable:false,filterable:false,
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_BUDGET_STATUS'); ?>', dataField: 'status_budget',width:'110',cellsalign: 'right'},
