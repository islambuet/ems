...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo base_url($CI->controller_url.'/index/get_items_all_area');?>";
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                autoheight: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_AREA_NAME'); ?>',dataField: 'area_id',pinned:true,filtertype: 'list',width:'200',rendered:tooltiprenderer},
