...
$config['table_basic_setup_arm_bank_accounts_receive'] = 'ems_basic_setup_arm_bank_accounts_receive';
$config['table_basic_setup_arm_bank_accounts_expense'] = 'ems_basic_setup_arm_bank_accounts_expense';
