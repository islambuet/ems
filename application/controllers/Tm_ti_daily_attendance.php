...
class Tm_ti_daily_attendance extends Root_Controller
{
    ...
    private function system_get_items()
    {
        ...
        foreach($items as &$item)
        {
            ...
            if(isset($tasks_list[$item['user_id']]))
            {
                $item['remarks_started']=$tasks_list[$item['user_id']]['text'];
            }
            else
            {
            ...
            if(isset($work_done_list[$item['user_id']]))
            {
                $item['remarks_reported']=$work_done_list[$item['user_id']]['text'];
            }
            else
            {
